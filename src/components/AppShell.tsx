  ...
  return (
    <header className="hidden md:flex sticky top-0 z-30 h-16 items-center gap-6 border-b border-line bg-card/90 px-8 backdrop-blur">
      ...
      <button
        ...
        className="flex h-9 items-center gap-1.5 rounded-[10px] border border-line bg-card px-3 text-[13px] text-ink-soft transition hover:bg-bg hover:text-ink"
        aria-label="로그아웃"
      >
        <Icon name="logout" size={15} color="#8B8377" />
