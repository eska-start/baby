...
export default function RecordPage() {
  ...
  const save = () => {
    ...
    addRecord({ date, height: heightNum, weight: weightNum, note: note || undefined });
    router.push("/");
  };
          ...
          <div className="md:col-span-7 space-y-3">
            ...
            <div className="flex items-center justify-between rounded-[14px] border border-line bg-card px-5 py-3.5">
              ...
              <input
                ...
                className="ko-num border-none bg-transparent text-[14px] font-medium text-ink outline-none"
              />
            </div>
